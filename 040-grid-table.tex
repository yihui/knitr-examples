...
{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# Loading required package: grid}}\begin{alltt}
...
\end{alltt}
\end{kframe}\includegraphics[width=\maxwidth]{figure/040-grid-table-draw-table} 
\end{knitrout}
