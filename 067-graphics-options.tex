...
\end{alltt}
\end{kframe}\begin{figure}[H]
\subfloat[one plot\label{fig:fig-sub1}]{\includegraphics[width=.49\linewidth]{figure/067-graphics-options-fig-sub-1} }
\subfloat[the other one\label{fig:fig-sub2}]{\includegraphics[width=.49\linewidth]{figure/067-graphics-options-fig-sub-2} }\caption[two plots]{two plots}\label{fig:fig-sub}
\end{figure}
