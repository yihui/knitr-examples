...
These options are vectorized for multiple plots per chunk: fig.cap, fig.scap, fig.alt, fig.env, fig.pos, fig.subcap, fig.note, out.width, out.height, out.extra, fig.link.
