...
knit_hooks$\hlfunctioncall{set}(document = \hlfunctioncall{function}(x) \{
    \hlfunctioncall{gsub}(\hlstring{"(\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}end\textbackslash{}\textbackslash{}\{knitrout\textbackslash{}\textbackslash{}\}[\textbackslash{}n]+)"}, \hlstring{"\textbackslash{}\textbackslash{}1\textbackslash{}\textbackslash{}\textbackslash{}\textbackslash{}noindent "}, x)
\})
\end{alltt}
\end{kframe}
\end{knitrout}
