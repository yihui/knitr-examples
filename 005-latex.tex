...
\end{alltt}
\end{kframe}\includegraphics[width=.8\textwidth]{figure/latex-cairo-scatter} 
\end{knitrout}
...
{\ttfamily\noindent\itshape\textcolor{messagecolor}{\#\# this is a message you should know}}\begin{alltt}
