...
\begin{alltt}
\hlkwd{plot}\hldef{(}\hlnum{1}\hldef{,} \hlkwc{main} \hldef{=} \hlsng{"Hello, Palatino"}\hldef{,} \hlkwc{xlab} \hldef{=} \hlsng{"This is x-axis"}\hldef{,} \hlkwc{ylab} \hldef{=} \hlsng{"This is y-axis"}\hldef{)}
\end{alltt}
\end{kframe}
