...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning: Removed 12 rows containing missing values (geom\_point).}}\end{kframe}
...
## 1 construct     0.008    0.000   0.007
## 2     build     0.524    0.008   0.536
## 3    render     0.220    0.008   0.229
## 4      draw     0.056    0.000   0.056
## 5     TOTAL     0.808    0.016   0.828
\end{verbatim}
\begin{alltt}
...
##        step user.self sys.self elapsed
## 1 construct     0.008    0.000   0.006
## 2     build     0.524    0.016   0.542
## 3    render     0.284    0.000   0.286
## 4      draw     0.116    0.000   0.118
## 5     TOTAL     0.932    0.016   0.952
\end{verbatim}
\begin{alltt}
\hlcom{# justification}
