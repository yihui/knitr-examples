...
![plot of chunk test-cache-a](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-a-1.png)
...
![plot of chunk test-cache-b](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-b-1.png)
...
![plot of chunk test-cache-c](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-c-1.png)
...
![plot of chunk test-cache-d](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-d-1.png)
...
![plot of chunk test-cache-e](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-e-1.png)
...
![plot of chunk test-cache-f](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-f-1.png)

``` r
plot(2:11)
```

![plot of chunk test-cache-f](https://pkg.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-f-2.png)
