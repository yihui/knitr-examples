...
![plot of chunk test-cache-a](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-a-1.png)
...
![plot of chunk test-cache-b](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-b-1.png)
...
![plot of chunk test-cache-c](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-c-1.png)
...
![plot of chunk test-cache-d](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-d-1.png)
...
![plot of chunk test-cache-e](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-e-1.png)
...
![plot of chunk test-cache-f](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-f-1.png)

```r
plot(2:11)
```

![plot of chunk test-cache-f](http://db.yihui.org/knitr-examples/figure/101-cache-levels-test-cache-f-2.png)
