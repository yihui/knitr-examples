...
![plot of chunk unnamed-chunk-2](https://pkg.yihui.org/knitr-examples/figure/001-minimal-unnamed-chunk-2-1.png)

``` r
hist(rnorm(1000))
```

![plot of chunk unnamed-chunk-2](https://pkg.yihui.org/knitr-examples/figure/001-minimal-unnamed-chunk-2-2.png)
